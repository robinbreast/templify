...
fn main() {
    ...
    let template_path = Path::new("examples/templates/manual_sections");
    // Prepare output folder by copying examples/targets/manual_sections to output/manual_sections
    let output_path = Path::new("output/manual_sections");
